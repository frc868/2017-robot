 ...
 *
 */
public class OldDriveDistance extends TimedCommand {
	 ...
	 */
	public OldDriveDistance(double cm, double timeout, boolean usePressurePlate) { //TODO could we instead use a trigger -> on plate press, run StopDriving command?
		super(timeout);
		if(DEBUG){
	...
	public OldDriveDistance(double cm) {
		this(cm, 4, false);
	}
	
	public OldDriveDistance(double cm, boolean usePressurePlate) {
		this(cm, 4, usePressurePlate);
	}
	
	public OldDriveDistance(double cm, double timeout) {
