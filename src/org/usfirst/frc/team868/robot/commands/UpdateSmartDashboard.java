...
public class UpdateSmartDashboard extends Command {
    ...
    /**
     * Use this command for adding any SmartDashboard output. e.g. Subsystem get
     * methods
     */
    ...
    protected void execute() {
        // This had been set to go as high as 200 times a second (actually it
        // had been infinite as it was 1/20 which is probably 0)
        // I turned it down to 20 times a second max - does it need to be
        // higher? (pkb)
        // I don't know, last year's robot was 1/200, so I assumed that it would
        // be fine. (cjd)
