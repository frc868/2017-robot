...
public abstract class GyroAdapter extends GyroBase {
    ...
    // Will be set to true if gyro is mounted such that the values it returns
    // are inverted
    ...
    @Override
    public double getRate() {
        throw new UnsupportedOperationException("This Gryo implementation does not provide a rate measurement");
    }
